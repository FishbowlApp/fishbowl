defmodule OctoconWeb.Router do
  ...
  scope "/api", OctoconWeb do
    ...
    scope "/settings" do
      ...
      post "/setup-encryption", SettingsController, :setup_encryption
      post "/recover-encryption", SettingsController, :recover_encryption
      post "/reset-encryption", SettingsController, :reset_encryption
      ...
      post "/unlink_apple", SettingsController, :unlink_apple

      post "/description", SettingsController, :update_description

      post "/delete-account", SettingsController, :delete_account
      post "/wipe-alters", SettingsController, :wipe_alters
