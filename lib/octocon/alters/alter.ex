defmodule Octocon.Alters.Alter do
  ...
  - Whether the alter is untracked (optional, a boolean)
  - Whether the alter is archived (optional, a boolean)
  ...
  schema "alters" do
    ...
    field :untracked, :boolean, default: false
    field :archived, :boolean, default: false
    field :pinned, :boolean, default: false
    field :last_fronted, :utc_datetime
