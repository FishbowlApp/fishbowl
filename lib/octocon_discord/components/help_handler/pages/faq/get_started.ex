  ...
  def embeds do
    [
      %Embed{
        ...
        - `/alter create name:Atlas` - Create an alter with the name "Atlas"
        - `/alter edit id:1 alias:Atlas pronouns:they/he` - Edit the new alter's alias and pronouns
        - `/alter view id:Atlas` - View the new alter's information (using the alias you just set)
        - `/front add id:Atlas` - Add the new alter to front
